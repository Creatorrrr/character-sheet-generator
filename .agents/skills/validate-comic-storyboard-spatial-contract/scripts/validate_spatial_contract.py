...
from comic_storyboard_validators import build_spatial_contract_report  # noqa: E402


def main() -> None:
    parser = argparse.ArgumentParser(description="Create a spatial_contract validation report.")
    ...
    report = build_spatial_contract_report(
        runner_path=RUNNER,
        run_dir=run_dir,
        page_ref=args.item,
        stage_id=args.stage,
    ...
    output = Path(args.output) if args.output else run_dir / "validation_reports" / args.stage / stem / "spatial_contract.json"
